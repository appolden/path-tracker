...
class Contribute extends Component {
  render() {
    ...
    let title = 'Donate';
    let metaDescription =
      'If you like this app and please consider making a donation towards the running costs.';
    switch (LanguageHelper.getLanguage(this.props.language)) {
      case 'fr':
        pageTitle = 'GR10 trail tracker - La page de don';
        title = 'Faire un don';
        metaDescription =
          "Si vous aimez cette application et s'il vous pla�t envisager de faire un don pour les frais de fonctionnement.";
        break;
      default:
        break;
    }
